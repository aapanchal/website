    ...
    5: function(e, t) {
        ! function(t) {
            ! function(e, t, n) {
                ...
                function s() { return "function" != typeof t.createElement ? t.createElement(arguments[0]) : T ? t.createElementNS.call(t, "http://www.w3.org/2000/svg", arguments[0]) : t.createElement.apply(t, arguments) }

                function a() { var e = t.body; return e || (e = s(T ? "svg" : "body"), e.fake = !0), e }
                ...
                function d(t, r) {
                    ...
                    if ("CSSSupportsRule" in e) { for (var i = []; o--;) i.push("(" + f(t[o]) + ":" + r + ")"); return i = i.join(" or "), u("@supports (" + i + ") { #modernizr { position: absolute; } }", function(e) { return "absolute" == c(e, null, "position") }) }
                    return n
                }
                ...
                function h(e, t, o, i) {
                    function a() { f && (delete j.style, delete j.modElem) }
                    if (i = !r(i, "undefined") && i, !r(o, "undefined")) { var u = d(e, o); if (!r(u, "undefined")) return u }
                    ...
                    for (h = e.length, c = 0; h > c; c++)
                        if (m = e[c], v = j.style[m], l(m, "-") && (m = p(m)), j.style[m] !== n) { if (i || r(o, "undefined")) return a(), "pfx" != t || m; try { j.style[m] = o } catch (e) {} if (j.style[m] != v) return a(), "pfx" != t || m }
                    return a(), !1
                }
                ...
                ! function() {
                    ...
                    b = r(e, "undefined") || r(e.call, "undefined") ? function(e, t) { return t in e && r(e.constructor.prototype[t], "undefined") } : function(t, n) { return e.call(t, n) }
                }(), S._l = {}, S.on = function(e, t) { this._l[e] || (this._l[e] = []), this._l[e].push(t), C.hasOwnProperty(e) && setTimeout(function() { C._trigger(e, C[e]) }, 0) }, S._trigger = function(e, t) {
                    if (this._l[e]) {
                        var n = this._l[e];
                        setTimeout(function() { var e; for (e = 0; e < n.length; e++)(0, n[e])(t) }, 0), delete this._l[e]
                    }
                }, C._q.push(function() { S.addTest = i }), C.addTest("json", "JSON" in e && "parse" in JSON && "stringify" in JSON), C.addTest("svg", !!t.createElementNS && !!t.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect);
                var P = S.testStyles = u;
                C.addTest("checked", function() { return P("#modernizr {position:absolute} #modernizr input {margin-left:10px} #modernizr :checked {margin-left:20px;display:block}", function(e) { var t = s("input"); return t.setAttribute("type", "checkbox"), t.setAttribute("checked", "checked"), e.appendChild(t), 20 === t.offsetLeft }) }), C.addTest("target", function() { var t = e.document; if (!("querySelectorAll" in t)) return !1; try { return t.querySelectorAll(":target"), !0 } catch (e) { return !1 } }), C.addTest("dataset", function() { var e = s("div"); return e.setAttribute("data-a-b", "c"), !(!e.dataset || "c" !== e.dataset.aB) }), C.addTest("details", function() { var e, t = s("details"); return "open" in t && (P("#modernizr details{display:block}", function(n) { n.appendChild(t), t.innerHTML = "<summary>a</summary>b", e = t.offsetHeight, t.open = !0, e = e != t.offsetHeight }), e) }), C.addTest("fetch", "fetch" in e);
                var z = "Moz O ms Webkit",
                    k = S._config.usePrefixes ? z.split(" ") : [];
                S._cssomPrefixes = k;
                var N = { elem: s("modernizr") };
                C._q.push(function() { delete N.elem });
                var j = { style: N.elem.style };
                C._q.unshift(function() { delete j.style });
                ...
                C.addTest("supports", E || O), C.addTest("csstransforms3d", function() {
                        ...
                        if (e && (!t || "webkitPerspective" in _.style)) {
                            var n;
                            C.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", P("#modernizr{width:0;height:0}" + n, function(t) { e = 7 === t.offsetWidth && 18 === t.offsetHeight })
                        }
                        return e
                    }),
                    function() {
